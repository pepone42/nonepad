...
impl Default for Theme {
    fn default() -> Self {
        ...
        let mut t: Theme = serde_json::from_str(&s).unwrap();
        t.style = syntect::highlighting::Theme {
            name: None,
            author: None,
...
impl Theme {
    pub fn to_env(&self, env: &mut Env) {
        ...
        env.set(
            ...
            Color::from_hex_str(&self.colors.selection_background).unwrap(),
        );
        env.set(WIDGET_SHADOW, Color::from_hex_str(&self.colors.widget_shadow).unwrap());
        env.set(
            TEXT_LINK_ACTIVE_FOREGROUND,
            Color::from_hex_str(&self.colors.text_link_active_foreground).unwrap(),
        );
        env.set(
            TEXT_LINK_FOREGROUND,
            Color::from_hex_str(&self.colors.text_link_foreground).unwrap(),
        );
        env.set(
            TEXT_PREFORMAT_FOREGROUND,
            Color::from_hex_str(&self.colors.text_preformat_foreground).unwrap(),
        );
        env.set(
            BUTTON_BACKGROUND,
            Color::from_hex_str(&self.colors.button_background).unwrap(),
        );
        env.set(
            BUTTON_FOREGROUND,
            Color::from_hex_str(&self.colors.button_foreground).unwrap(),
        );
        env.set(
            BUTTON_HOVER_BACKGROUND,
            Color::from_hex_str(&self.colors.button_hover_background).unwrap(),
        );
        env.set(
            DROPDOWN_BACKGROUND,
            Color::from_hex_str(&self.colors.dropdown_background).unwrap(),
        );
        env.set(
            DROPDOWN_LIST_BACKGROUND,
            Color::from_hex_str(&self.colors.dropdown_list_background).unwrap(),
        );
        env.set(
            INPUT_BACKGROUND,
            Color::from_hex_str(&self.colors.input_background).unwrap(),
        );
        env.set(INPUT_BORDER, Color::from_hex_str(&self.colors.input_border).unwrap());
        env.set(
            INPUT_FOREGROUND,
            Color::from_hex_str(&self.colors.input_foreground).unwrap(),
        );
        env.set(
            INPUT_PLACEHOLDER_FOREGROUND,
            Color::from_hex_str(&self.colors.input_placeholder_foreground).unwrap(),
        );
        env.set(
            SCROLLBAR_SHADOW,
            Color::from_hex_str(&self.colors.scrollbar_shadow).unwrap(),
        );
        env.set(
            SCROLLBAR_SLIDER_ACTIVE_BACKGROUND,
            Color::from_hex_str(&self.colors.scrollbar_slider_active_background).unwrap(),
        );
        env.set(
            SCROLLBAR_SLIDER_BACKGROUND,
            Color::from_hex_str(&self.colors.scrollbar_slider_background).unwrap(),
        );
        env.set(
            SCROLLBAR_SLIDER_HOVER_BACKGROUND,
            Color::from_hex_str(&self.colors.scrollbar_slider_hover_background).unwrap(),
        );
        env.set(
            BADGE_FOREGROUND,
            Color::from_hex_str(&self.colors.badge_foreground).unwrap(),
        );
        env.set(
            BADGE_BACKGROUND,
            Color::from_hex_str(&self.colors.badge_background).unwrap(),
        );
        env.set(
            PROGRESS_BAR_BACKGROUND,
            Color::from_hex_str(&self.colors.progress_bar_background).unwrap(),
        );
        env.set(
            LIST_ACTIVE_SELECTION_BACKGROUND,
            Color::from_hex_str(&self.colors.list_active_selection_background).unwrap(),
        );
        env.set(
            LIST_ACTIVE_SELECTION_FOREGROUND,
            Color::from_hex_str(&self.colors.list_active_selection_foreground).unwrap(),
        );
        env.set(
            LIST_INACTIVE_SELECTION_BACKGROUND,
            Color::from_hex_str(&self.colors.list_inactive_selection_background).unwrap(),
        );
        env.set(
            LIST_INACTIVE_SELECTION_FOREGROUND,
            Color::from_hex_str(&self.colors.list_inactive_selection_foreground).unwrap(),
        );
        env.set(
            LIST_HOVER_FOREGROUND,
            Color::from_hex_str(&self.colors.list_hover_foreground).unwrap(),
        );
        env.set(
            LIST_FOCUS_FOREGROUND,
            Color::from_hex_str(&self.colors.list_focus_foreground).unwrap(),
        );
        env.set(
            LIST_FOCUS_BACKGROUND,
            Color::from_hex_str(&self.colors.list_focus_background).unwrap(),
        );
        env.set(
            LIST_HOVER_BACKGROUND,
            Color::from_hex_str(&self.colors.list_hover_background).unwrap(),
        );
        env.set(
            LIST_DROP_BACKGROUND,
            Color::from_hex_str(&self.colors.list_drop_background).unwrap(),
        );
        env.set(
            LIST_HIGHLIGHT_FOREGROUND,
            Color::from_hex_str(&self.colors.list_highlight_foreground).unwrap(),
        );
        env.set(
            LIST_ERROR_FOREGROUND,
            Color::from_hex_str(&self.colors.list_error_foreground).unwrap(),
        );
        env.set(
            LIST_WARNING_FOREGROUND,
            Color::from_hex_str(&self.colors.list_warning_foreground).unwrap(),
        );
        env.set(
            ACTIVITY_BAR_BACKGROUND,
            Color::from_hex_str(&self.colors.activity_bar_background).unwrap(),
        );
        env.set(
            ACTIVITY_BAR_DROP_BACKGROUND,
            Color::from_hex_str(&self.colors.activity_bar_drop_background).unwrap(),
        );
        env.set(
            ACTIVITY_BAR_FOREGROUND,
            Color::from_hex_str(&self.colors.activity_bar_foreground).unwrap(),
        );
        env.set(
            ACTIVITY_BAR_BADGE_BACKGROUND,
            Color::from_hex_str(&self.colors.activity_bar_badge_background).unwrap(),
        );
        env.set(
            ACTIVITY_BAR_BADGE_FOREGROUND,
            Color::from_hex_str(&self.colors.activity_bar_badge_foreground).unwrap(),
        );
        env.set(
            SIDE_BAR_BACKGROUND,
            Color::from_hex_str(&self.colors.side_bar_background).unwrap(),
        );
        env.set(
            SIDE_BAR_FOREGROUND,
            Color::from_hex_str(&self.colors.side_bar_foreground).unwrap(),
        );
        env.set(
            SIDE_BAR_SECTION_HEADER_BACKGROUND,
            Color::from_hex_str(&self.colors.side_bar_section_header_background).unwrap(),
        );
        env.set(
            SIDE_BAR_SECTION_HEADER_FOREGROUND,
            Color::from_hex_str(&self.colors.side_bar_section_header_foreground).unwrap(),
        );
        env.set(
            SIDE_BAR_TITLE_FOREGROUND,
            Color::from_hex_str(&self.colors.side_bar_title_foreground).unwrap(),
        );
        env.set(
            EDITOR_GROUP_BORDER,
            Color::from_hex_str(&self.colors.editor_group_border).unwrap(),
        );
        env.set(
            EDITOR_GROUP_DROP_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_group_drop_background).unwrap(),
        );
        env.set(
            EDITOR_GROUP_HEADER_NO_TABS_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_group_header_no_tabs_background).unwrap(),
        );
        env.set(
            EDITOR_GROUP_HEADER_TABS_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_group_header_tabs_background).unwrap(),
        );
        env.set(
            TAB_ACTIVE_BACKGROUND,
            Color::from_hex_str(&self.colors.tab_active_background).unwrap(),
        );
        env.set(
            TAB_ACTIVE_FOREGROUND,
            Color::from_hex_str(&self.colors.tab_active_foreground).unwrap(),
        );
        env.set(TAB_BORDER, Color::from_hex_str(&self.colors.tab_border).unwrap());
        env.set(
            TAB_ACTIVE_BORDER,
            Color::from_hex_str(&self.colors.tab_active_border).unwrap(),
        );
        env.set(
            TAB_UNFOCUSED_ACTIVE_BORDER,
            Color::from_hex_str(&self.colors.tab_unfocused_active_border).unwrap(),
        );
        env.set(
            TAB_INACTIVE_BACKGROUND,
            Color::from_hex_str(&self.colors.tab_inactive_background).unwrap(),
        );
        env.set(
            TAB_INACTIVE_FOREGROUND,
            Color::from_hex_str(&self.colors.tab_inactive_foreground).unwrap(),
        );
        env.set(
            TAB_UNFOCUSED_ACTIVE_FOREGROUND,
            Color::from_hex_str(&self.colors.tab_unfocused_active_foreground).unwrap(),
        );
        env.set(
            TAB_UNFOCUSED_INACTIVE_FOREGROUND,
            Color::from_hex_str(&self.colors.tab_unfocused_inactive_foreground).unwrap(),
        );
        env.set(
            EDITOR_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_background).unwrap(),
        );
        env.set(
            EDITOR_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_foreground).unwrap(),
        );
        env.set(
            EDITOR_HOVER_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_hover_highlight_background).unwrap(),
        );
        env.set(
            EDITOR_FIND_MATCH_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_find_match_background).unwrap(),
        );
        env.set(
            EDITOR_FIND_MATCH_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_find_match_highlight_background).unwrap(),
        );
        env.set(
            EDITOR_FIND_RANGE_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_find_range_highlight_background).unwrap(),
        );
        env.set(
            EDITOR_LINE_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_line_highlight_background).unwrap(),
        );
        env.set(
            EDITOR_LINE_HIGHLIGHT_BORDER,
            Color::from_hex_str(&self.colors.editor_line_highlight_border).unwrap(),
        );
        env.set(
            EDITOR_INACTIVE_SELECTION_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_inactive_selection_background).unwrap(),
        );
        env.set(
            EDITOR_SELECTION_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_selection_background).unwrap(),
        );
        env.set(
            EDITOR_SELECTION_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_selection_highlight_background).unwrap(),
        );
        env.set(
            EDITOR_RANGE_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_range_highlight_background).unwrap(),
        );
        env.set(
            EDITOR_WORD_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_word_highlight_background).unwrap(),
        );
        env.set(
            EDITOR_WORD_HIGHLIGHT_STRONG_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_word_highlight_strong_background).unwrap(),
        );
        env.set(
            EDITOR_ERROR_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_error_foreground).unwrap(),
        );
        env.set(
            EDITOR_ERROR_BORDER,
            Color::from_hex_str(&self.colors.editor_error_border).unwrap(),
        );
        env.set(
            EDITOR_WARNING_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_warning_foreground).unwrap(),
        );
        env.set(
            EDITOR_INFO_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_info_foreground).unwrap(),
        );
        env.set(
            EDITOR_WARNING_BORDER,
            Color::from_hex_str(&self.colors.editor_warning_border).unwrap(),
        );
        env.set(
            EDITOR_CURSOR_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_cursor_foreground).unwrap(),
        );
        env.set(
            EDITOR_INDENT_GUIDE_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_indent_guide_background).unwrap(),
        );
        env.set(
            EDITOR_LINE_NUMBER_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_line_number_foreground).unwrap(),
        );
        env.set(
            EDITOR_WHITESPACE_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_whitespace_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_BORDER,
            Color::from_hex_str(&self.colors.editor_overview_ruler_border).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_CURRENT_CONTENT_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_current_content_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_INCOMING_CONTENT_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_incoming_content_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_FIND_MATCH_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_find_match_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_RANGE_HIGHLIGHT_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_range_highlight_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_SELECTION_HIGHLIGHT_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_selection_highlight_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_WORD_HIGHLIGHT_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_word_highlight_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_WORD_HIGHLIGHT_STRONG_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_word_highlight_strong_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_MODIFIED_FOREGRUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_modified_foregrund).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_ADDED_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_added_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_DELETED_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_deleted_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_ERROR_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_error_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_WARNING_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_warning_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_INFO_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_info_foreground).unwrap(),
        );
        env.set(
            EDITOR_OVERVIEW_RULER_BRACKET_MATCH_FOREGROUND,
            Color::from_hex_str(&self.colors.editor_overview_ruler_bracket_match_foreground).unwrap(),
        );
        env.set(
            EDITOR_GUTTER_MODIFIED_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_gutter_modified_background).unwrap(),
        );
        env.set(
            EDITOR_GUTTER_ADDED_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_gutter_added_background).unwrap(),
        );
        env.set(
            EDITOR_GUTTER_DELETED_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_gutter_deleted_background).unwrap(),
        );
        env.set(
            DIFF_EDITOR_INSERTED_TEXT_BACKGROUND,
            Color::from_hex_str(&self.colors.diff_editor_inserted_text_background).unwrap(),
        );
        env.set(
            DIFF_EDITOR_REMOVED_TEXT_BACKGROUND,
            Color::from_hex_str(&self.colors.diff_editor_removed_text_background).unwrap(),
        );
        env.set(
            EDITOR_WIDGET_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_widget_background).unwrap(),
        );
        env.set(
            EDITOR_WIDGET_BORDER,
            Color::from_hex_str(&self.colors.editor_widget_border).unwrap(),
        );
        env.set(
            EDITOR_SUGGEST_WIDGET_BACKGROUND,
            Color::from_hex_str(&self.colors.editor_suggest_widget_background).unwrap(),
        );
        env.set(
            PEEK_VIEW_BORDER,
            Color::from_hex_str(&self.colors.peek_view_border).unwrap(),
        );
        env.set(
            PEEK_VIEW_EDITOR_MATCH_HIGHLIGHT_BACKGROUND,
            Color::from_hex_str(&self.colors.peek_view_editor_match_highlight_background).unwrap(),
        );
        env.set(
            PEEK_VIEW_EDITOR_GUTTER_BACKGROUND,
            Color::from_hex_str(&self.colors.peek_view_editor_gutter_background).unwrap(),
        );
        env.set(
            PEEK_VIEW_EDITOR_BACKGROUND,
            Color::from_hex_str(&self.colors.peek_view_editor_background).unwrap(),
        );
        env.set(
            PEEK_VIEW_RESULT_BACKGROUND,
            Color::from_hex_str(&self.colors.peek_view_result_background).unwrap(),
        );
        env.set(
            PEEK_VIEW_TITLE_BACKGROUND,
            Color::from_hex_str(&self.colors.peek_view_title_background).unwrap(),
        );
        env.set(
            MERGE_CURRENT_HEADER_BACKGROUND,
            Color::from_hex_str(&self.colors.merge_current_header_background).unwrap(),
        );
        env.set(
            MERGE_CURRENT_CONTENT_BACKGROUND,
            Color::from_hex_str(&self.colors.merge_current_content_background).unwrap(),
        );
        env.set(
            MERGE_INCOMING_HEADER_BACKGROUND,
            Color::from_hex_str(&self.colors.merge_incoming_header_background).unwrap(),
        );
        env.set(
            MERGE_INCOMING_CONTENT_BACKGROUND,
            Color::from_hex_str(&self.colors.merge_incoming_content_background).unwrap(),
        );
        env.set(
            PANEL_BACKGROUND,
            Color::from_hex_str(&self.colors.panel_background).unwrap(),
        );
        env.set(PANEL_BORDER, Color::from_hex_str(&self.colors.panel_border).unwrap());
        env.set(
            PANEL_TITLE_ACTIVE_BORDER,
            Color::from_hex_str(&self.colors.panel_title_active_border).unwrap(),
        );
        env.set(
            STATUS_BAR_BACKGROUND,
            Color::from_hex_str(&self.colors.status_bar_background).unwrap(),
        );
        env.set(
            STATUS_BAR_DEBUGGING_BACKGROUND,
            Color::from_hex_str(&self.colors.status_bar_debugging_background).unwrap(),
        );
        env.set(
            STATUS_BAR_DEBUGGING_FOREGROUND,
            Color::from_hex_str(&self.colors.status_bar_debugging_foreground).unwrap(),
        );
        env.set(
            STATUS_BAR_NO_FOLDER_FOREGROUND,
            Color::from_hex_str(&self.colors.status_bar_no_folder_foreground).unwrap(),
        );
        env.set(
            STATUS_BAR_NO_FOLDER_BACKGROUND,
            Color::from_hex_str(&self.colors.status_bar_no_folder_background).unwrap(),
        );
        env.set(
            STATUS_BAR_FOREGROUND,
            Color::from_hex_str(&self.colors.status_bar_foreground).unwrap(),
        );
        env.set(
            STATUS_BAR_ITEM_ACTIVE_BACKGROUND,
            Color::from_hex_str(&self.colors.status_bar_item_active_background).unwrap(),
        );
        env.set(
            STATUS_BAR_ITEM_HOVER_BACKGROUND,
            Color::from_hex_str(&self.colors.status_bar_item_hover_background).unwrap(),
        );
        env.set(
            STATUS_BAR_ITEM_PROMINENT_BACKGROUND,
            Color::from_hex_str(&self.colors.status_bar_item_prominent_background).unwrap(),
        );
        env.set(
            STATUS_BAR_ITEM_PROMINENT_HOVER_BACKGROUND,
            Color::from_hex_str(&self.colors.status_bar_item_prominent_hover_background).unwrap(),
        );
        env.set(
            STATUS_BAR_BORDER,
            Color::from_hex_str(&self.colors.status_bar_border).unwrap(),
        );
        env.set(
            TITLE_BAR_ACTIVE_BACKGROUND,
            Color::from_hex_str(&self.colors.title_bar_active_background).unwrap(),
        );
        env.set(
            TITLE_BAR_ACTIVE_FOREGROUND,
            Color::from_hex_str(&self.colors.title_bar_active_foreground).unwrap(),
        );
        env.set(
            TITLE_BAR_INACTIVE_BACKGROUND,
            Color::from_hex_str(&self.colors.title_bar_inactive_background).unwrap(),
        );
        env.set(
            TITLE_BAR_INACTIVE_FOREGROUND,
            Color::from_hex_str(&self.colors.title_bar_inactive_foreground).unwrap(),
        );
        env.set(
            NOTIFICATION_CENTER_HEADER_FOREGROUND,
            Color::from_hex_str(&self.colors.notification_center_header_foreground).unwrap(),
        );
        env.set(
            NOTIFICATION_CENTER_HEADER_BACKGROUND,
            Color::from_hex_str(&self.colors.notification_center_header_background).unwrap(),
        );
        env.set(
            EXTENSION_BUTTON_PROMINENT_FOREGROUND,
            Color::from_hex_str(&self.colors.extension_button_prominent_foreground).unwrap(),
        );
        env.set(
            EXTENSION_BUTTON_PROMINENT_BACKGROUND,
            Color::from_hex_str(&self.colors.extension_button_prominent_background).unwrap(),
        );
        env.set(
            EXTENSION_BUTTON_PROMINENT_HOVER_BACKGROUND,
            Color::from_hex_str(&self.colors.extension_button_prominent_hover_background).unwrap(),
        );
        env.set(
            PICKER_GROUP_BORDER,
            Color::from_hex_str(&self.colors.picker_group_border).unwrap(),
        );
        env.set(
            PICKER_GROUP_FOREGROUND,
            Color::from_hex_str(&self.colors.picker_group_foreground).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BRIGHT_BLACK,
            Color::from_hex_str(&self.colors.terminal_ansi_bright_black).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BLACK,
            Color::from_hex_str(&self.colors.terminal_ansi_black).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BLUE,
            Color::from_hex_str(&self.colors.terminal_ansi_blue).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BRIGHT_BLUE,
            Color::from_hex_str(&self.colors.terminal_ansi_bright_blue).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BRIGHT_CYAN,
            Color::from_hex_str(&self.colors.terminal_ansi_bright_cyan).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_CYAN,
            Color::from_hex_str(&self.colors.terminal_ansi_cyan).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BRIGHT_MAGENTA,
            Color::from_hex_str(&self.colors.terminal_ansi_bright_magenta).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_MAGENTA,
            Color::from_hex_str(&self.colors.terminal_ansi_magenta).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BRIGHT_RED,
            Color::from_hex_str(&self.colors.terminal_ansi_bright_red).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_RED,
            Color::from_hex_str(&self.colors.terminal_ansi_red).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_YELLOW,
            Color::from_hex_str(&self.colors.terminal_ansi_yellow).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BRIGHT_YELLOW,
            Color::from_hex_str(&self.colors.terminal_ansi_bright_yellow).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_BRIGHT_GREEN,
            Color::from_hex_str(&self.colors.terminal_ansi_bright_green).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_GREEN,
            Color::from_hex_str(&self.colors.terminal_ansi_green).unwrap(),
        );
        env.set(
            TERMINAL_ANSI_WHITE,
            Color::from_hex_str(&self.colors.terminal_ansi_white).unwrap(),
        );
        env.set(
            TERMINAL_SELECTION_BACKGROUND,
            Color::from_hex_str(&self.colors.terminal_selection_background).unwrap(),
        );
        env.set(
            TERMINAL_CURSOR_BACKGROUND,
            Color::from_hex_str(&self.colors.terminal_cursor_background).unwrap(),
        );
        env.set(
            TERMINAL_CURSOR_FOREGROUND,
            Color::from_hex_str(&self.colors.terminal_cursor_foreground).unwrap(),
        );
        env.set(
            GIT_DECORATION_MODIFIED_RESOURCE_FOREGROUND,
            Color::from_hex_str(&self.colors.git_decoration_modified_resource_foreground).unwrap(),
        );
        env.set(
            GIT_DECORATION_DELETED_RESOURCE_FOREGROUND,
            Color::from_hex_str(&self.colors.git_decoration_deleted_resource_foreground).unwrap(),
        );
        env.set(
            GIT_DECORATION_UNTRACKED_RESOURCE_FOREGROUND,
            Color::from_hex_str(&self.colors.git_decoration_untracked_resource_foreground).unwrap(),
        );
        env.set(
            GIT_DECORATION_CONFLICTING_RESOURCE_FOREGROUND,
            Color::from_hex_str(&self.colors.git_decoration_conflicting_resource_foreground).unwrap(),
        );
        env.set(
            GIT_DECORATION_SUBMODULE_RESOURCE_FOREGROUND,
            Color::from_hex_str(&self.colors.git_decoration_submodule_resource_foreground).unwrap(),
        );
    }
}
